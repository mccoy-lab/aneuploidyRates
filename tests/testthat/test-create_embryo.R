# Tests from Tessera Package (line 2-74)
...
test_that("Embryo has aneuploid specified chromosomes", {
  ...
  for(i in 1:31){
    ...
    e = create_embryo(n.cells = 100, n.chrs = 31, prop.aneuploid = chrs, dispersal = 0)
...
test_that("Number of aneuploid cells matches input aneuploidy level", {
  ...
  for(i in seq(0, 1, 0.05)){
    e = create_embryo(n.cells = 100, n.chrs = 1, prop.aneuploid = i, dispersal = 0)
    expect_equal(tessera::countAneuploidCells(e), i*100)
  }
...
test_that("RNG seed makes reproducible embryos", {
  ...
  e = create_embryo(n.cells = 100, n.chrs = 1, prop.aneuploid = 0.5, dispersal = 0, rng.seed = 42)
  e2 = create_embryo(n.cells = 100, n.chrs = 1, prop.aneuploid = 0.5, dispersal = 0, rng.seed = 42)
  expect_identical(e, e2)

  # Embryos with different seeds should be different
  e3 = create_embryo(n.cells = 100, n.chrs = 1, prop.aneuploid = 0.5, dispersal = 0, rng.seed = 43)
...
test_that("Clustered embryos have all aneuploid cells adjacent to another", {
  ...
  for(aneu in seq(0.05, 0.95, 0.05)){
    # clustered embryo
    e = create_embryo(n.cells = 100, n.chrs = 1, prop.aneuploid = aneu, dispersal = 0)
